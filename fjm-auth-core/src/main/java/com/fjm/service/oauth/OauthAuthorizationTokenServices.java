...
/**
 * @Author: jinmingfong
 * @CreateTime: 2021-03-22 下午4:12
 * @Description:
 */
public class OauthAuthorizationTokenServices implements AuthorizationServerTokenServices, ConsumerTokenServices {
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        OAuth2AccessToken beforeAccessToken = tokenStore.getAccessToken(authentication);
        ...
        if (!reuseRefreshToken) {
            //同步清除oauthToken
            tokenStore.removeAccessToken(beforeAccessToken);
